...
//    }
    ...
    public int getAlbumByKey(String albumID) throws ApiException {
        ApiResponse<AlbumInfo> resp = getAlbumByKeyWithHttpInfo(albumID);
    ...
    public com.squareup.okhttp.Call newAlbumCall(File image, AlbumsProfile profile, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (profile != null)
        localVarFormParams.put("profile", buildProfileJson(profile));
...
//    private String buildProfileJson(AlbumsProfile profile) {
//        // Implement your logic to convert the AlbumsProfile object to a JSON string
//        // You can use a library like Jackson, Gson, or manual serialization/deserialization
//        return "{\"artist\":\"" + profile.getArtist() + "\",\"title\":\"" + profile.getTitle() + "\",\"year\":" + profile.getYear() + "}";
//    }
...
//    }
    ...
    public int newAlbum(File image, AlbumsProfile profile) throws ApiException {
        ApiResponse<ImageMetaData> resp = newAlbumWithHttpInfo(image, profile);
        return resp.getStatusCode();
    }
    /**
